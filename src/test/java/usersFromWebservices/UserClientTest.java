...
public class UserClientTest extends Mockito{
	...
	public void getFirstPage_should_return_6_users() throws IOException, InterruptedException{
		...
		userDTOList = Stream.generate(UserDTO::new).limit(EXPECTED_NUMBER_USERS).collect(Collectors.toList());
	...
	@Test
	public void getFirstPage_first_user_firstName_should_be_George() throws IOException, InterruptedException{
		UserDTO george = new UserDTO();
		george.setFirstName("George");
		george.setLastName("Bluth");
